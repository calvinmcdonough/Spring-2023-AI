...
def main():
  ...
  ################################
  # Add your debug image generation here Bonus problem 1 (B1)
  ################################
  ...
  ################################
  # B4 Evaluate your alg on test data
  ################################
  ...
  for i in range(len(predict)):
    ...
    for j in range(len(predict[i])):
      if true_max < predict[i][j]:
        true_max = predict[i][j]
        guess = j
    submit.append([guess])
  ...
  pd.DataFrame(submit).to_csv("submit copy.csv")
...
class LinearLayer:
  ...
  #################################################
  # Q1 Implementing Backward Pass for Linear
  #################################################
